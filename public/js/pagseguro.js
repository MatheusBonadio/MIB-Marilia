$("#sessaoCad").click(function() {
  $.ajax({
    url: getUrl() + '/controllers/dao/PagSeguroDAO.php',
    type: 'post',
    dataType: 'json',
    async: false,
    timeout: 20000,
